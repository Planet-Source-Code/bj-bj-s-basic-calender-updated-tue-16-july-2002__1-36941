Attribute VB_Name = "modTrialVersion"
Option Explicit
...
Declare Function RegDeleteValue Lib "advapi32.dll" Alias "RegDeleteKeyA" (ByVal hKey As Long, ByVal lpSubKey As String) As Long
