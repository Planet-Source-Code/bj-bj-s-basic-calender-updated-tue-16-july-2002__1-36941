...
Begin VB.Form frmBasicCalender 
   ...
   Begin VB.Menu mnuPopup 
      ...
      End
      Begin VB.Menu mnuShowHideWindowsTime 
         Caption         =   "Show Windows Time"
         Visible         =   0   'False
      End
      Begin VB.Menu mnuShowHideWindowsTime_TimeZone 
         Caption         =   "Show Windows Time & Time Zone"
         Visible         =   0   'False
      End
...
'    If remove_close Then DeleteMenu hMenu, 0, MF_BYPOSITION ' Removes Remove
    ...
    hMenu1 = DeleteMenu(hMenu, 6, MF_BYPOSITION) And hMenu1 = DeleteMenu(hMenu, 5, MF_BYPOSITION)
...
mnuWinStart.Caption = GetStringValue("HKEY_CURRENT_USER\Software\BJ\BJ's How to Get...\BJ's Basic Calender", "Windows Startup")
If mnuWinStart.Caption = "Error" Then
mnuWinStart.Caption = "Add to Startup"
End If

If GetStringValue("HKEY_CURRENT_USER\Software\BJ\BJ's How to Get...\BJ's Basic Calender", "Calender Left") = "Error" Then
Me.Left = 4260
frmColours.Left = Me.Left + 1200
Else
Me.Left = GetStringValue("HKEY_CURRENT_USER\Software\BJ\BJ's How to Get...\BJ's Basic Calender", "Calender Left")
frmColours.Left = Me.Left + 1200
End If

If GetStringValue("HKEY_CURRENT_USER\Software\BJ\BJ's How to Get...\BJ's Basic Calender", "Calender Top") = "Error" Then
Me.Top = 15
Else
Me.Top = GetStringValue("HKEY_CURRENT_USER\Software\BJ\BJ's How to Get...\BJ's Basic Calender", "Calender Top")
End If

If GetStringValue("HKEY_CURRENT_USER\Software\BJ\BJ's How to Get...\BJ's Basic Calender", "Calender Height") = "Error" Then
Me.Height = 6030
Else
Me.Height = GetStringValue("HKEY_CURRENT_USER\Software\BJ\BJ's How to Get...\BJ's Basic Calender", "Calender Height")
End If

If GetStringValue("HKEY_CURRENT_USER\Software\BJ\BJ's How to Get...\BJ's Basic Calender", "Windows Time Top") = "Error" Then
Me.Frame4.Top = 4230
Else
Me.Frame4.Top = GetStringValue("HKEY_CURRENT_USER\Software\BJ\BJ's How to Get...\BJ's Basic Calender", "Windows Time Top")
End If

If GetStringValue("HKEY_CURRENT_USER\Software\BJ\BJ's How to Get...\BJ's Basic Calender", "Show\Hide TimeZone") = "Error" Then
Me.mnuShowHideTimeZone.Caption = "Hide TimeZone"
Else
Me.mnuShowHideTimeZone.Caption = GetStringValue("HKEY_CURRENT_USER\Software\BJ\BJ's How to Get...\BJ's Basic Calender", "Show\Hide TimeZone")
End If

If GetStringValue("HKEY_CURRENT_USER\Software\BJ\BJ's How to Get...\BJ's Basic Calender", "Show\Hide Windows Time") = "Error" Then
Me.mnuShowHideWindowsTime.Caption = "Hide Windows Time"
Else
Me.mnuShowHideWindowsTime.Caption = GetStringValue("HKEY_CURRENT_USER\Software\BJ\BJ's How to Get...\BJ's Basic Calender", "Show\Hide Windows Time")
End If

If GetStringValue("HKEY_CURRENT_USER\Software\BJ\BJ's How to Get...\BJ's Basic Calender", "Show\Hide Windows Time & Time Zone") = "Error" Then
Me.mnuShowHideWindowsTime_TimeZone.Caption = "Hide Windows Time & Time Zone"
Else
Me.mnuShowHideWindowsTime_TimeZone.Caption = GetStringValue("HKEY_CURRENT_USER\Software\BJ\BJ's How to Get...\BJ's Basic Calender", "Show\Hide Windows Time & Time Zone")
End If
...
mnuHour.Caption = "12 Hour"
End If
If mnuHour.Caption = "12 Hour" Then
MyTime = Format(Time, "hh:mm:ss ampm") '04:39:58 PM
mnuHour.Caption = "24 Hour"
Else
mnuHour.Caption = "24 Hour"
...
MsgBox "Your system time has been reset to: " & m_StrAtomicTime, vbInformation, "System Time update - Synchronized"
StopCursorAnimation
Else
Dim Msg, Style, Title, Response, MyString
...
mnuHour.Caption = "24 Hour"
Else
If mnuHour.Caption = "24 Hour" Then
'MyTime = Format(Time, "h:m:s") '16:39:58
MyTime = Format(Time, "HH:MM:ss") '16:39:58
mnuHour.Caption = "12 Hour"
End If
End If
...
'AboutBox Me.hwnd
    Dim About As cShellLink                                              ' ShellLink class variable
   Set About = New cShellLink
   About.SystemsAboutBox (hwnd)
   Set About = Nothing
End Sub
...
MsgBox "You can now start BJ's Basic Calender" & vbNewLine & "from your Run menu by typing in" & vbNewLine & vbNewLine & "bj'sbc", vbInformation, App.EXEName & " is now in your Run Menu"
End Sub
...
Me.mnuShowHideTimeZone.Caption = "Hide TimeZone"
mnuShowHideWindowsTime.Enabled = True
Me.Frame4.Top = 4160
Me.Height = 6030
...
Private Sub mnuShowHideWindowsTime_Click()

If Me.mnuShowHideWindowsTime.Caption = GetStringValue("HKEY_CURRENT_USER\Software\BJ\BJ's How to Get...\BJ's Basic Calender", "Show\Hide Windows Time") = "Error" Then
Me.mnuShowHideWindowsTime.Caption = "Hide Windows Time"
End If

If Me.mnuShowHideWindowsTime.Caption = "Show Windows Time" Then
Me.mnuShowHideWindowsTime.Caption = "Hide Windows Time"
mnuShowHideTimeZone.Enabled = True
Me.Height = 5910
SetStringValue "HKEY_CURRENT_USER\Software\BJ\BJ's How to Get...\BJ's Basic Calender", "Calender Height", Me.Height
SetStringValue "HKEY_CURRENT_USER\Software\BJ\BJ's How to Get...\BJ's Basic Calender", "Show\Hide Windows Time", "Show Windows Time"

Else

If Me.mnuShowHideWindowsTime.Caption = "Hide Windows Time" Then
Me.mnuShowHideWindowsTime.Caption = "Show Windows Time"
mnuShowHideTimeZone.Enabled = False
Me.Height = 4590
SetStringValue "HKEY_CURRENT_USER\Software\BJ\BJ's How to Get...\BJ's Basic Calender", "Calender Height", Me.Height
SetStringValue "HKEY_CURRENT_USER\Software\BJ\BJ's How to Get...\BJ's Basic Calender", "Show\Hide Windows Time", "Hide Windows Time"
End If
End If

End Sub

Private Sub mnuShowHideWindowsTime_TimeZone_Click()

If Me.mnuShowHideWindowsTime_TimeZone.Caption = GetStringValue("HKEY_CURRENT_USER\Software\BJ\BJ's How to Get...\BJ's Basic Calender", "Show\Hide Windows Time") = "Error" Then
Me.mnuShowHideWindowsTime_TimeZone.Caption = "Hide Windows Time & Time Zone"
End If

If Me.mnuShowHideWindowsTime_TimeZone.Caption = "Show Windows Time & Time Zone" Then
Me.mnuShowHideWindowsTime_TimeZone.Caption = "Hide Windows Time & Time Zone"
mnuShowHideTimeZone.Enabled = True
mnuShowHideWindowsTime.Enabled = True
Me.Height = 5910
SetStringValue "HKEY_CURRENT_USER\Software\BJ\BJ's How to Get...\BJ's Basic Calender", "Calender Height", Me.Height
SetStringValue "HKEY_CURRENT_USER\Software\BJ\BJ's How to Get...\BJ's Basic Calender", "Show\Hide Windows Time & Time Zone", "Hide Windows Time & Time Zone"

Else

If Me.mnuShowHideWindowsTime_TimeZone.Caption = "Hide Windows Time & Time Zone" Then
Me.mnuShowHideWindowsTime_TimeZone.Caption = "Show Windows Time & Time Zone"
mnuShowHideTimeZone.Enabled = False
mnuShowHideWindowsTime.Enabled = False
Me.Height = 3840
SetStringValue "HKEY_CURRENT_USER\Software\BJ\BJ's How to Get...\BJ's Basic Calender", "Calender Height", Me.Height
SetStringValue "HKEY_CURRENT_USER\Software\BJ\BJ's How to Get...\BJ's Basic Calender", "Show\Hide Windows Time & Time Zone", "Show Windows Time & Time Zone"
End If
End If
...
'Label7.Caption = "Days left in " & Format(Today, "yy") & " is " & DayinYear - Format(Today, "y")
ElseIf DayinYear = 365 Then
'Label7.Caption = "Days left in " & Format(Today, "yy") & " is " & DayinYear - Format(Today, "y")
'Label8.Caption = "Weeks left in " & Format(Today, "yy") & " is " & 52 - Format(Today, "ww")
